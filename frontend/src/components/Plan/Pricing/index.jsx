    ...
    <section className="py-24">
      <div className="container mx-auto px-4">
        ...
        <p className="text-gray-600 text-lg text-center mb-10 max-w-lg mx-auto">
          Para criar seus primeiros posts, escolha um dos planos abaixo. Não requer cartão de crédito.
        </p>
        ...
        <div className="flex flex-wrap mb-24 -mx-4">
          ...
          <div className="w-full lg:w-1/2 p-4">
            <div className="bg-blue-500 rounded-3xl px-8 lg:px-10 pb-14 pt-10 h-full">
